...
const (
	UserService_VerifyUsers_FullMethodName = "/user.UserService/VerifyUsers"
...
func (c *userServiceClient) VerifyUsers(ctx context.Context, in *VerifyUsersRequest, opts ...grpc.CallOption) (*VerifyUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyUsersResponse)
	err := c.cc.Invoke(ctx, UserService_VerifyUsers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) VerifyUsers(context.Context, *VerifyUsersRequest) (*VerifyUsersResponse, error) {
...
func _UserService_VerifyUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyUsersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).VerifyUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_VerifyUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).VerifyUsers(ctx, req.(*VerifyUsersRequest))
	}

...
type GetContactsRequest struct {
	...
	ExcludeIds    []uint32               `protobuf:"varint,2,rep,packed,name=exclude_ids,json=excludeIds,proto3" json:"exclude_ids,omitempty"`
...
func (x *GetContactsRequest) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetContactsRequest) GetExcludeIds() []uint32 {
	if x != nil {
		return x.ExcludeIds
	}
	return nil
...
func (x *GetContactsRequest) GetQuery() string {
	if x != nil {
		return x.Query
	}
	return ""
...
func (x *GetContactsResponse) GetUsers() []*User {
	if x != nil {
		return x.Users
	}
	return nil
...
const file_user_user_proto_rawDesc = "" +
	...
	"\tall_valid\x18\x01 \x01(\bR\ballValid\"d\n" +
	"\x12GetContactsRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\rR\x06userId\x12\x1f\n" +
	"\vexclude_ids\x18\x02 \x03(\rR\n" +
	"excludeIds\x12\x14\n" +
	"\x05query\x18\x03 \x01(\tR\x05query\"7\n" +
	"\x13GetContactsResponse\x12 \n" +
	"\x05users\x18\x01 \x03(\v2\n" +
	".user.UserR\x05users2\x94\x02\n" +
	"\vUserService\x12B\n" +
	...
	"\vGetContacts\x12\x18.user.GetContactsRequest\x1a\x19.user.GetContactsResponseB;Z9github.com/Yusufdot101/ripple-proto/golang/user/v4;userpbb\x06proto3"
...
var file_user_user_proto_goTypes = []any{
	...
	(*GetContactsRequest)(nil),  // 7: user.GetContactsRequest
	(*GetContactsResponse)(nil), // 8: user.GetContactsResponse
}
var file_user_user_proto_depIdxs = []int32{
	1, // 0: user.GetUsersResponse.users:type_name -> user.User
	1, // 1: user.SearchUsersResponse.users:type_name -> user.User
	1, // 2: user.GetContactsResponse.users:type_name -> user.User
	...
	7, // 6: user.UserService.GetContacts:input_type -> user.GetContactsRequest
	6, // 7: user.UserService.VerifyUsers:output_type -> user.VerifyUsersResponse
	3, // 8: user.UserService.GetUsers:output_type -> user.GetUsersResponse
	5, // 9: user.UserService.SearchUsers:output_type -> user.SearchUsersResponse
	8, // 10: user.UserService.GetContacts:output_type -> user.GetContactsResponse
